...
<head>
    ...
    <title>Login Pegawai - Aplikasi Absensi & Payroll</title>
    <link href="{{ asset('css/app.css') }}" rel="stylesheet">
</head>

<body>
    <div class="w-[300px] mt-[100px] mb-40 mx-auto text-center">
        <div class="text-sm font-semibold mb-1">Login Pegawai Aplikasi</div>
        <div class="text-xl font-bold mb-1">Absensi & Payroll</div>

        <form class="mt-10" action="/pegawai/login" method="POST">
            @csrf
