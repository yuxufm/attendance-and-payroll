<nav class="flex flex-col text-sm">
    ...
    @if (session()->get('hak_akses') === 'admin')
        ...
        <a class="anp-sidebar-menu" href="{{ url('admin/absensi') }}">Data Absensi</a>
        <a class="anp-sidebar-menu" href="{{ url('admin/payslip') }}">Data Payslip</a>
    ...
    @if (session()->get('hak_akses') === 'pegawai')
        ...
        <a class="anp-sidebar-menu" href="{{ url('pegawai/absensi') }}">Data Absensi</a>
        <a class="anp-sidebar-menu" href="{{ url('pegawai/payslip') }}">Data Payslip</a>
